...
void getSensorVal(void) {
	...
	g_sensor_FL_lowpass = SEN_LOWPASS*g_sensor_FL_lowpass+(1-SEN_LOWPASS)*g_sensor_FL;
	g_sensor_FR_lowpass = SEN_LOWPASS*g_sensor_FR_lowpass+(1-SEN_LOWPASS)*g_sensor_FR;
	g_sensor_L_lowpass = SEN_LOWPASS*g_sensor_L_lowpass+(1-SEN_LOWPASS)*g_sensor_L;
	g_sensor_R_lowpass = SEN_LOWPASS*g_sensor_R_lowpass+(1-SEN_LOWPASS)*g_sensor_R;
